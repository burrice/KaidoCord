...
const buildConfigs = ([
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///KaidocordPatcher\n" + sourceMapFooter("patcher") },
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///KaidocordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "Vencord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///KaidocordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // Vencord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///KaidocordDesktopMain\n" + sourceMapFooter("vencordDesktopMain") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
